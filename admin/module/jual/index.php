...
?>
    ...
    <div class="card  mb-3">
        ...
        <div class="card-body" style="display: flex; flex-direction: column;">
            <input type="text" id="cari" class="form-control" name="cari" placeholder="Nama Barang" style="margin-bottom: 10px; width: 100%;">
            <div class="table-responsive" style="flex: 1; width: 100%;">
								...
								<tr>
									...
									<td>
										...
										<a href="fungsi/hapus/hapus.php?jual=jual&id=<?php echo $isi['id_penjualan'];?>&brg=<?php echo $isi['id_barang'];?>
											&jml=<?php echo $isi['jumlah']; ?>"  class="btn btn-danger">Batal
										</a>
									</td>
								</tr>
